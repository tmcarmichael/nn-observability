"""Mistral 7B v0.3: full protocol for fifth architecture family.

Model: mistralai/Mistral-7B-v0.3 | GPU: H100 SXM 80GB | 7 seeds (43-49) | 350 ex/dim
...
out_path = Path('/workspace/mistral7b_results.json')
