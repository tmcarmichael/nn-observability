"""Phi-3 Mini 4K: full protocol for sixth architecture family.

Model: microsoft/Phi-3-mini-4k-instruct | GPU: H100 SXM 80GB | 7 seeds (43-49) | 350 ex/dim
...
CHECKPOINT_PATH = Path('/workspace/qwen7b_v3_checkpoint.json')
...
out_path = Path('/workspace/phi3_mini_results.json')
