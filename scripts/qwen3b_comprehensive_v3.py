"""Qwen 2.5 3B base: v3 with full battery including control sensitivity.

Model: Qwen/Qwen2.5-3B | GPU: H100 / A100 | 7 seeds (43-49) | 350 ex/dim
...
out_path = Path('/workspace/qwen3b_v3_results.json')
