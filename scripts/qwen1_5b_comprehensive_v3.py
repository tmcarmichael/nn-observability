"""Qwen 2.5 1.5B base: v3 at 350 ex/dim for consistent scaling curve.

Model: Qwen/Qwen2.5-1.5B | GPU: H100 / A100 | 7 seeds (43-49) | 350 ex/dim
...
Usage: pip install transformers datasets scipy && python scripts/qwen1_5b_comprehensive_v3.py
"""
...
out_path = Path('/workspace/qwen1_5b_v3_results.json')
