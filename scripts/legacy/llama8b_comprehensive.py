"""Llama 3.1 8B: full protocol rerun (confirms preliminary +0.088).

Model: meta-llama/Llama-3.1-8B | GPU: H100 SXM 80GB | 7 seeds (43-49) | 350 ex/dim
...
Usage: pip install transformers datasets scipy && python scripts/llama8b_comprehensive.py
"""
...
CHECKPOINT_PATH = Path("/workspace/llama8b_checkpoint.json")
...
out_path = Path("/workspace/llama8b_results.json")
