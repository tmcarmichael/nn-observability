"""Qwen 2.5 1.5B Instruct: v3 at 350 ex/dim for consistent scaling curve.

Model: Qwen/Qwen2.5-1.5B-Instruct | GPU: H100 / A100 | 7 seeds (43-49) | 350 ex/dim
...
Usage: pip install transformers datasets scipy && python scripts/qwen3b_comprehensive_v3.py
"""
...
def collect_layer_data(model, tokenizer, docs, layer, device, max_tokens=200000,
    ...
    def process_batch(batch):
        ...
        for b in range(input_ids.size(0)):
            ...
            all_softmax.append(sm); all_entropy.append(ent); all_norms.append(norms)
            total += h.size(0)
...
output = {
    ...
    'protocol': {'layer_select_seed': LAYER_SELECT_SEED, 'eval_seeds': EVAL_SEEDS,
                 'target_ex_per_dim': TARGET_EX_PER_DIM, 'batch_size': 8},
...
out_path = Path('/workspace/qwen1_5b_instruct_v3_results.json')
