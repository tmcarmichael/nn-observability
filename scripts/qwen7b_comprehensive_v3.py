"""Qwen 2.5 7B base: v3 with optimized GPU utilization.

Model: Qwen/Qwen2.5-7B | GPU: H100 SXM 80GB | 7 seeds (43-49) | 350 ex/dim
...
out_path = Path('/workspace/qwen7b_v3_results.json')
